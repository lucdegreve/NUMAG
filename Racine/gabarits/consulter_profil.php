						...
						<div class="col-sm-4">
							<div class="card border-danger">
							  ...
							  <ul class="list-group list-group-flush">
							    <li class="list-group-item">01/01/1982</li>
							    <li class="list-group-item">Balizac (33730)</li>
							    <li class="list-group-item">Api Ferme</li>
							  </ul>
								<a href="benchmark.php" class="btn btn-danger">Membre Premium</a>
							</div>
						</div>
						...
						<div class="col-sm-8">
	      				...
	      				<div class="card-body">
	        				...
	        				<button href="#" class="btn btn-secondary btn-lg disabled" tabindex="-1" role="button" aria-disabled="true">Ecologie</button>
									...
									<button href="#" class="btn btn-secondary btn-lg disabled" tabindex="-1" role="button" aria-disabled="true">Miel</button>
									<button href="#" class="btn btn-secondary btn-lg disabled" tabindex="-1" role="button" aria-disabled="true">Abeilles</button>
									<button href="#" class="btn btn-secondary btn-lg disabled" tabindex="-1" role="button" aria-disabled="true">Numérique</button>
	      				</div>
	    				</div>
							<br/>
							<div class="card">
