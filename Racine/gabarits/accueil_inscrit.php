				...
				<div id="actualites">
					<div class="jumbotron HauteurMax">
						...
						<hr class="my-4">
							...
							// for ($j=0; $j<$NBL; $j++)
							for ($j=0; $j<5; $j++)
							{ echo '<div class="card bg-light border-info mb-3 pading_lateral" style="border-width:0.05em">';
								...
								while ($k<count($TabActu) AND $verif == false)
								{
									if ($id == $TabActu[$k][0])
									{
										...
										echo "<p class='card-text' style='font-size:1.2em'><B>".$TabActu[$k][1]."</B> - ".$jour."/".$mois."/".$annee."</p>";
